...
class TrDetGraph:
    ...
    def plot_points(self, x, y, avg_err):
        ...
        if avg_err > 1e-1:
            ...
            ax.plot(x, y, '.', color = 'red', alpha = .3, zorder = 10,  markersize = 10)

        elif avg_err > 1e-5:
            ax.plot(x, y, '.', color = '#800080', alpha = .3, zorder = 10,  markersize = 10)

        elif avg_err > 1e-8:
            ax.plot(x, y, '.', color = 'blue', alpha = .3, zorder = 10,  markersize = 10)
        else:
    ...
    def display(self, ev_type, pp_type, loop_limit):
        ...
        custom_handles = [Line2D([0], [0], marker = 'o', markerfacecolor = 'r', color = 'w', alpha = 1, markersize = 7, label = '$μ_{Err}$ > 1e-1' ),
        Line2D([0], [0], marker = 'o', markerfacecolor = 'r', color = 'w', alpha = .3, markersize = 7, label = '$μ_{Err}$ > 1e-3' ),
        Line2D([0], [0], marker = 'o', markerfacecolor = '#800080', color = 'w', alpha = .3, markersize = 7, label = '$μ_{Err}$ > 1e-5' ),
        Line2D([0], [0], marker = 'o', markerfacecolor = 'b', color = 'w', alpha = .3, markersize = 7, label = '$μ_{Err}$ > 1e-8' ),
